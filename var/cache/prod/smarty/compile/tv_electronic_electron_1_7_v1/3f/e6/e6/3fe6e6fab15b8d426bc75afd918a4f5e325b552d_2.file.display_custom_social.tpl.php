...
/* Smarty version 3.1.43, created on 2022-09-28 14:30:09
  from '/Applications/MAMP/htdocs/cbdestock/modules/tvcmscustomsetting/views/templates/front/display_custom_social.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_63343e515df477_66095571',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3fe6e6fab15b8d426bc75afd918a4f5e325b552d' => 
    array (
      0 => '/Applications/MAMP/htdocs/cbdestock/modules/tvcmscustomsetting/views/templates/front/display_custom_social.tpl',
      1 => 1664286345,
      2 => 'file',
    ),
  ),
...
function content_63343e515df477_66095571 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
?>
    <?php if ($_smarty_tpl->tpl_vars['LeftStickyStatus']->value) {
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_20241760463343e5156eda5_84185114', 'block_social');
}
...
/* {block 'block_social'} */
class Block_20241760463343e5156eda5_84185114 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'block_social' => 
  array (
    0 => 'Block_20241760463343e5156eda5_84185114',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="block-social tv-footer-social-icon wow slideInLeft"><div class="tv-footer-social-icon-wrapper"><div class="tv-footer-social-icon-inner"><?php if (!empty(Configuration::get('BLOCKSOCIAL_FACEBOOK'))) {?><div class="tvblock-social-content tvfacebook-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_FACEBOOK'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_TWITTER'))) {?><div class="tvblock-social-content tvtwitter-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_TWITTER'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_RSS'))) {?><div class="tvblock-social-content tvrss-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_RSS'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_YOUTUBE'))) {?><div class="tvblock-social-content tvyoutube-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_YOUTUBE'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_PINTEREST'))) {?><div class="tvblock-social-content tvpinterest-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_PINTEREST'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_VIMEO'))) {?><div class="tvblock-social-content tvvimeo-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_VIMEO'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_INSTAGRAM'))) {?><div class="tvblock-social-content tvinstagram-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_INSTAGRAM'), ENT_QUOTES, 'UTF-8');?>
